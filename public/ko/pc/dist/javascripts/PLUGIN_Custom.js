...
$(function () {
    ...
    $(".donate_utm_link").each(function () {
        ...
        var _utmSource = URLParser(locationUrl).getParam('utm_source'),
            ...
            _utmMotive = URLParser(locationUrl).getParam('motivecode'),
            _utmChannel = URLParser(locationUrl).getParam('channelcode');
        ...
        if (!_utmMotive) _utmMotive = "";
        if (!_utmChannel) _utmChannel = "";

        var utmArr = ["utm_source=" + _utmSource, "&utm_medium=" + _utmMedium, "&utm_term=" + _utmTerm, "&utm_content=" + _utmContent, "&utm_campaign=" + _utmCampaign, "&motivecode=" + _utmMotive, "&channelcode=" + _utmChannel];
        var DONUS_utmURL = "";
        if (_defaultUtm) {
            DONUS_utmURL = $donationBtn + "&" + utmArr[0] + utmArr[1] + utmArr[2] + utmArr[3] + utmArr[4] + utmArr[5] + utmArr[6];
        } else {
            DONUS_utmURL = $donationBtn + "?" + utmArr[0] + utmArr[1] + utmArr[2] + utmArr[3] + utmArr[4] + utmArr[5] + utmArr[6];
        }
